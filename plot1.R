...
summed <- ddply(NEI,~year,summarise,total=sum(Emissions))

# Create the ploit
barplot(summed$total, names.arg=summed$year, main="PM2.5 Emissions Over Time", ylab="Total PM2.5 emissions (tons)", xlab="Year")
